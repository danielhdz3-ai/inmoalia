...
const CATEGORIES = [
  ...
  { slug: 'sillas-oficina', name: 'Sillas de oficina' },
  { slug: 'sillas-ergonomicas', name: 'Sillas ergonómicas' },
  { slug: 'sillas-comedor', name: 'Sillas de comedor' },
  { slug: 'sillas-exterior', name: 'Sillas de exterior' },
